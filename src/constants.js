...
const HTTP_STATUS_CODES = {
  100: HTTP_STATUS_PHRASES.CONTINUE,
  101: HTTP_STATUS_PHRASES.SWITCHING_PROTOCOLS,
  102: HTTP_STATUS_PHRASES.PROCESSING,
  200: HTTP_STATUS_PHRASES.OK,
  201: HTTP_STATUS_PHRASES.CREATED,
  202: HTTP_STATUS_PHRASES.ACCEPTED,
  203: HTTP_STATUS_PHRASES.NON_AUTHORITATIVE_INFORMATION,
  204: HTTP_STATUS_PHRASES.NO_CONTENT,
  205: HTTP_STATUS_PHRASES.RESET_CONTENT,
  206: HTTP_STATUS_PHRASES.PARTIAL_CONTENT,
  207: HTTP_STATUS_PHRASES.MULTI_STATUS,
  226: HTTP_STATUS_PHRASES.IM_USED,
  300: HTTP_STATUS_PHRASES.MULTIPLE_CHOICES,
  301: HTTP_STATUS_PHRASES.MOVED_PERMANENTLY,
  302: HTTP_STATUS_PHRASES.FOUND,
  303: HTTP_STATUS_PHRASES.SEE_OTHER,
  304: HTTP_STATUS_PHRASES.NOT_MODIFIED,
  305: HTTP_STATUS_PHRASES.USE_PROXY,
  307: HTTP_STATUS_PHRASES.TEMPORARY_REDIRECT,
  308: HTTP_STATUS_PHRASES.PERMANENT_REDIRECT,
  400: HTTP_STATUS_PHRASES.BAD_REQUEST,
  401: HTTP_STATUS_PHRASES.UNAUTHORIZED,
  402: HTTP_STATUS_PHRASES.PAYMENT_REQUIRED,
  403: HTTP_STATUS_PHRASES.FORBIDDEN,
  404: HTTP_STATUS_PHRASES.NOT_FOUND,
  405: HTTP_STATUS_PHRASES.METHOD_NOT_ALLOWED,
  406: HTTP_STATUS_PHRASES.NOT_ACCEPTABLE,
  407: HTTP_STATUS_PHRASES.PROXY_AUTHENTICATION_REQUIRED,
  408: HTTP_STATUS_PHRASES.REQUEST_TIMEOUT,
  409: HTTP_STATUS_PHRASES.CONFLICT,
  410: HTTP_STATUS_PHRASES.GONE,
  411: HTTP_STATUS_PHRASES.LENGTH_REQUIRED,
  412: HTTP_STATUS_PHRASES.PRECONDITION_FAILED,
  413: HTTP_STATUS_PHRASES.PAYLOAD_TOO_LARGE,
  414: HTTP_STATUS_PHRASES.URI_TOO_LONG,
  415: HTTP_STATUS_PHRASES.UNSUPPORTED_MEDIA_TYPE,
  416: HTTP_STATUS_PHRASES.RANGE_NOT_SATISFIABLE,
  417: HTTP_STATUS_PHRASES.EXPECTATION_FAILED,
  418: HTTP_STATUS_PHRASES.IM_A_TEAPOT,
  422: HTTP_STATUS_PHRASES.UNPROCESSABLE_ENTITY,
  423: HTTP_STATUS_PHRASES.LOCKED,
  424: HTTP_STATUS_PHRASES.FAILED_DEPENDENCY,
  426: HTTP_STATUS_PHRASES.UPGRADE_REQUIRED,
  428: HTTP_STATUS_PHRASES.PRECONDITION_REQUIRED,
  429: HTTP_STATUS_PHRASES.TOO_MANY_REQUESTS,
  431: HTTP_STATUS_PHRASES.REQUEST_HEADER_FIELDS_TOO_LARGE,
  451: HTTP_STATUS_PHRASES.UNAVAILABLE_FOR_LEGAL_REASONS,
  500: HTTP_STATUS_PHRASES.INTERNAL_SERVER_ERROR,
  501: HTTP_STATUS_PHRASES.NOT_IMPLEMENTED,
  502: HTTP_STATUS_PHRASES.BAD_GATEWAY,
  503: HTTP_STATUS_PHRASES.SERVICE_UNAVAILABLE,
  504: HTTP_STATUS_PHRASES.GATEWAY_TIME_OUT,
  505: HTTP_STATUS_PHRASES.HTTP_VERSION_NOT_SUPPORTED,
  506: HTTP_STATUS_PHRASES.VARIANT_ALSO_NEGOTIATES,
  507: HTTP_STATUS_PHRASES.INSUFFICIENT_STORAGE,
  511: HTTP_STATUS_PHRASES.NETWORK_AUTHENTICATION_REQUIRED
};
